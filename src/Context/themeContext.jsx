...
export function ThemeProvider({ children }) {
  ...
  const theme = {
    ...
    toggleTheme,
    colors: {
      background: darkMode ? "#2d2d2d" : "#ffffff", // Fondo oscuro o claro
      ...
      navBar: darkMode ? "#1a1a1a" : "#9EDD9B", // Color de la barra de navegación
      login: darkMode ? "#28a745" : "#1a1a1a", // Color del botón de login
    },
  };
