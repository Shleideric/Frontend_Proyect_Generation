...
import { Link as RouterLink } from "react-router-dom"; // Link de react-router para navegación interna
...
export default function Footer() {
  ...
  const { colors, darkMode, navBar } = useCustomTheme();
  ...
  return (
    ...
    <Box
      component="footer"
      sx={{
        backgroundColor: colors.navBar, // Color de fondo según el modo
        color: colors.text,
    ...
    >
      ...
      >
        ...
        >
          &copy; {new Date().getFullYear()} Mi EcoMarket
        </Typography>
      </Box>
    </Box>
  );
