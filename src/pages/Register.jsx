...
export default function Register() {
  ...
  const handleSubmit = (e) => {
    ...
    usuarioService.register(datosUsuario)

      .then((response) => {
        console.log("Usuario registrado:", response.data);
        // Redirigir o mostrar un mensaje de éxito

        navigate("/ecoMarket/login"); // Redirige a la página de inicio de sesión después del registro exitoso
      })
      .catch((error) => {
      ...
      >
        <Card variant="outlined">
          ...
          <Typography sx={{ textAlign: "center", mt: 2 }}>
            ¿Ya tienes cuenta?{" "}
            <Link href="/ecoMarket/login" variant="body2">
              Inicia sesión aquí
            </Link>
          </Typography>
        </Card>
